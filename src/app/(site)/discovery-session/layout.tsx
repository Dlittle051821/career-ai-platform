 ...
 * /discovery-session subtree (covers /discovery-session/book today, and any
 * future page added under this folder automatically). Authenticated-only —
 * see the "/discovery-session" prefix in PROTECTED_PATHS,
...
export default function DiscoverySessionLayout({ children }: { children: React.ReactNode }) {
  return children;
}
