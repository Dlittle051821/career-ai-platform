...
export const metadata: Metadata = {
  title: "Dashboard",
  // M17A Step 2 — permanent, page-level noindex protection, independent of
  // the temporary site-wide noindex on src/app/(site)/layout.tsx. This page
  // is authenticated-only (see PROTECTED_PATHS in
  // src/lib/supabase/middleware.ts) and must stay unindexable even after
  // that temporary blanket noindex is eventually lifted from the public
  // pages. See M17A_SEO_AUDIT.md §H for the reasoning.
